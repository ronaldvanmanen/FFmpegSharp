...
namespace FFmpegSharp.Interop
{
    public static unsafe partial class FFmpeg
    {
        ...
        [NativeTypeName("#define FF_API_COMPUTE_PKT_FIELDS2 (LIBAVFORMAT_VERSION_MAJOR < 59)")]
        public const bool FF_API_COMPUTE_PKT_FIELDS2 = (58 < 59);

        [NativeTypeName("#define FF_API_OLD_OPEN_CALLBACKS (LIBAVFORMAT_VERSION_MAJOR < 59)")]
        public const bool FF_API_OLD_OPEN_CALLBACKS = (58 < 59);

        [NativeTypeName("#define FF_API_LAVF_AVCTX (LIBAVFORMAT_VERSION_MAJOR < 59)")]
        public const bool FF_API_LAVF_AVCTX = (58 < 59);

        [NativeTypeName("#define FF_API_HTTP_USER_AGENT (LIBAVFORMAT_VERSION_MAJOR < 59)")]
        public const bool FF_API_HTTP_USER_AGENT = (58 < 59);

        [NativeTypeName("#define FF_API_HLS_WRAP (LIBAVFORMAT_VERSION_MAJOR < 59)")]
        public const bool FF_API_HLS_WRAP = (58 < 59);

        [NativeTypeName("#define FF_API_HLS_USE_LOCALTIME (LIBAVFORMAT_VERSION_MAJOR < 59)")]
        public const bool FF_API_HLS_USE_LOCALTIME = (58 < 59);

        [NativeTypeName("#define FF_API_LAVF_KEEPSIDE_FLAG (LIBAVFORMAT_VERSION_MAJOR < 59)")]
        public const bool FF_API_LAVF_KEEPSIDE_FLAG = (58 < 59);

        [NativeTypeName("#define FF_API_OLD_ROTATE_API (LIBAVFORMAT_VERSION_MAJOR < 59)")]
        public const bool FF_API_OLD_ROTATE_API = (58 < 59);

        [NativeTypeName("#define FF_API_FORMAT_GET_SET (LIBAVFORMAT_VERSION_MAJOR < 59)")]
        public const bool FF_API_FORMAT_GET_SET = (58 < 59);

        [NativeTypeName("#define FF_API_OLD_AVIO_EOF_0 (LIBAVFORMAT_VERSION_MAJOR < 59)")]
        public const bool FF_API_OLD_AVIO_EOF_0 = (58 < 59);

        [NativeTypeName("#define FF_API_LAVF_FFSERVER (LIBAVFORMAT_VERSION_MAJOR < 59)")]
        public const bool FF_API_LAVF_FFSERVER = (58 < 59);

        [NativeTypeName("#define FF_API_FORMAT_FILENAME (LIBAVFORMAT_VERSION_MAJOR < 59)")]
        public const bool FF_API_FORMAT_FILENAME = (58 < 59);

        [NativeTypeName("#define FF_API_OLD_RTSP_OPTIONS (LIBAVFORMAT_VERSION_MAJOR < 59)")]
        public const bool FF_API_OLD_RTSP_OPTIONS = (58 < 59);

        [NativeTypeName("#define FF_API_DASH_MIN_SEG_DURATION (LIBAVFORMAT_VERSION_MAJOR < 59)")]
        public const bool FF_API_DASH_MIN_SEG_DURATION = (58 < 59);

        [NativeTypeName("#define FF_API_LAVF_MP4A_LATM (LIBAVFORMAT_VERSION_MAJOR < 59)")]
        public const bool FF_API_LAVF_MP4A_LATM = (58 < 59);

        [NativeTypeName("#define FF_API_AVIOFORMAT (LIBAVFORMAT_VERSION_MAJOR < 59)")]
        public const bool FF_API_AVIOFORMAT = (58 < 59);

        [NativeTypeName("#define FF_API_DEMUXER_OPEN (LIBAVFORMAT_VERSION_MAJOR < 59)")]
        public const bool FF_API_DEMUXER_OPEN = (58 < 59);

        [NativeTypeName("#define FF_API_CHAPTER_ID_INT (LIBAVFORMAT_VERSION_MAJOR < 59)")]
        public const bool FF_API_CHAPTER_ID_INT = (58 < 59);

        [NativeTypeName("#define FF_API_LAVF_PRIV_OPT (LIBAVFORMAT_VERSION_MAJOR < 60)")]
        public const bool FF_API_LAVF_PRIV_OPT = (58 < 60);

        [NativeTypeName("#define FF_API_R_FRAME_RATE 1")]
