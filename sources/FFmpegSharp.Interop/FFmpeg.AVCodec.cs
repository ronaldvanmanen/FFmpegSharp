...
using static FFmpegSharp.Interop.AVCodecID;
using static FFmpegSharp.Interop.AVPacketSideDataType;
...
namespace FFmpegSharp.Interop
{
    public static unsafe partial class FFmpeg
    {
        ...
        [NativeTypeName("#define FF_API_AVCTX_TIMEBASE (LIBAVCODEC_VERSION_MAJOR < 59)")]
        public const bool FF_API_AVCTX_TIMEBASE = (58 < 59);

        [NativeTypeName("#define FF_API_CODED_FRAME (LIBAVCODEC_VERSION_MAJOR < 59)")]
        public const bool FF_API_CODED_FRAME = (58 < 59);

        [NativeTypeName("#define FF_API_SIDEDATA_ONLY_PKT (LIBAVCODEC_VERSION_MAJOR < 59)")]
        public const bool FF_API_SIDEDATA_ONLY_PKT = (58 < 59);

        [NativeTypeName("#define FF_API_VDPAU_PROFILE (LIBAVCODEC_VERSION_MAJOR < 59)")]
        public const bool FF_API_VDPAU_PROFILE = (58 < 59);

        [NativeTypeName("#define FF_API_CONVERGENCE_DURATION (LIBAVCODEC_VERSION_MAJOR < 59)")]
        public const bool FF_API_CONVERGENCE_DURATION = (58 < 59);

        [NativeTypeName("#define FF_API_AVPICTURE (LIBAVCODEC_VERSION_MAJOR < 59)")]
        public const bool FF_API_AVPICTURE = (58 < 59);

        [NativeTypeName("#define FF_API_AVPACKET_OLD_API (LIBAVCODEC_VERSION_MAJOR < 59)")]
        public const bool FF_API_AVPACKET_OLD_API = (58 < 59);

        [NativeTypeName("#define FF_API_RTP_CALLBACK (LIBAVCODEC_VERSION_MAJOR < 59)")]
        public const bool FF_API_RTP_CALLBACK = (58 < 59);

        [NativeTypeName("#define FF_API_VBV_DELAY (LIBAVCODEC_VERSION_MAJOR < 59)")]
        public const bool FF_API_VBV_DELAY = (58 < 59);

        [NativeTypeName("#define FF_API_CODER_TYPE (LIBAVCODEC_VERSION_MAJOR < 59)")]
        public const bool FF_API_CODER_TYPE = (58 < 59);

        [NativeTypeName("#define FF_API_STAT_BITS (LIBAVCODEC_VERSION_MAJOR < 59)")]
        public const bool FF_API_STAT_BITS = (58 < 59);

        [NativeTypeName("#define FF_API_PRIVATE_OPT (LIBAVCODEC_VERSION_MAJOR < 59)")]
        public const bool FF_API_PRIVATE_OPT = (58 < 59);

        [NativeTypeName("#define FF_API_ASS_TIMING (LIBAVCODEC_VERSION_MAJOR < 59)")]
        public const bool FF_API_ASS_TIMING = (58 < 59);

        [NativeTypeName("#define FF_API_OLD_BSF (LIBAVCODEC_VERSION_MAJOR < 59)")]
        public const bool FF_API_OLD_BSF = (58 < 59);

        [NativeTypeName("#define FF_API_COPY_CONTEXT (LIBAVCODEC_VERSION_MAJOR < 59)")]
        public const bool FF_API_COPY_CONTEXT = (58 < 59);

        [NativeTypeName("#define FF_API_GET_CONTEXT_DEFAULTS (LIBAVCODEC_VERSION_MAJOR < 59)")]
        public const bool FF_API_GET_CONTEXT_DEFAULTS = (58 < 59);

        [NativeTypeName("#define FF_API_NVENC_OLD_NAME (LIBAVCODEC_VERSION_MAJOR < 59)")]
        public const bool FF_API_NVENC_OLD_NAME = (58 < 59);

        [NativeTypeName("#define FF_API_STRUCT_VAAPI_CONTEXT (LIBAVCODEC_VERSION_MAJOR < 59)")]
        public const bool FF_API_STRUCT_VAAPI_CONTEXT = (58 < 59);

        [NativeTypeName("#define FF_API_MERGE_SD_API (LIBAVCODEC_VERSION_MAJOR < 59)")]
        public const bool FF_API_MERGE_SD_API = (58 < 59);

        [NativeTypeName("#define FF_API_TAG_STRING (LIBAVCODEC_VERSION_MAJOR < 59)")]
        public const bool FF_API_TAG_STRING = (58 < 59);

        [NativeTypeName("#define FF_API_GETCHROMA (LIBAVCODEC_VERSION_MAJOR < 59)")]
        public const bool FF_API_GETCHROMA = (58 < 59);

        [NativeTypeName("#define FF_API_CODEC_GET_SET (LIBAVCODEC_VERSION_MAJOR < 59)")]
        public const bool FF_API_CODEC_GET_SET = (58 < 59);

        [NativeTypeName("#define FF_API_USER_VISIBLE_AVHWACCEL (LIBAVCODEC_VERSION_MAJOR < 59)")]
        public const bool FF_API_USER_VISIBLE_AVHWACCEL = (58 < 59);

        [NativeTypeName("#define FF_API_LOCKMGR (LIBAVCODEC_VERSION_MAJOR < 59)")]
        public const bool FF_API_LOCKMGR = (58 < 59);

        [NativeTypeName("#define FF_API_NEXT (LIBAVCODEC_VERSION_MAJOR < 59)")]
        public const bool FF_API_NEXT = (58 < 59);

        [NativeTypeName("#define FF_API_UNSANITIZED_BITRATES (LIBAVCODEC_VERSION_MAJOR < 59)")]
        public const bool FF_API_UNSANITIZED_BITRATES = (58 < 59);

        [NativeTypeName("#define FF_API_OPENH264_SLICE_MODE (LIBAVCODEC_VERSION_MAJOR < 59)")]
        public const bool FF_API_OPENH264_SLICE_MODE = (58 < 59);

        [NativeTypeName("#define FF_API_OPENH264_CABAC (LIBAVCODEC_VERSION_MAJOR < 59)")]
        public const bool FF_API_OPENH264_CABAC = (58 < 59);

        [NativeTypeName("#define FF_API_UNUSED_CODEC_CAPS (LIBAVCODEC_VERSION_MAJOR < 59)")]
        public const bool FF_API_UNUSED_CODEC_CAPS = (58 < 59);

        [NativeTypeName("#define FF_API_AVPRIV_PUT_BITS (LIBAVCODEC_VERSION_MAJOR < 59)")]
        public const bool FF_API_AVPRIV_PUT_BITS = (58 < 59);

        [NativeTypeName("#define FF_API_OLD_ENCDEC (LIBAVCODEC_VERSION_MAJOR < 59)")]
        public const bool FF_API_OLD_ENCDEC = (58 < 59);

        [NativeTypeName("#define FF_API_AVCODEC_PIX_FMT (LIBAVCODEC_VERSION_MAJOR < 59)")]
        public const bool FF_API_AVCODEC_PIX_FMT = (58 < 59);

        [NativeTypeName("#define FF_API_MPV_RC_STRATEGY (LIBAVCODEC_VERSION_MAJOR < 59)")]
        public const bool FF_API_MPV_RC_STRATEGY = (58 < 59);

        [NativeTypeName("#define FF_API_PARSER_CHANGE (LIBAVCODEC_VERSION_MAJOR < 59)")]
        public const bool FF_API_PARSER_CHANGE = (58 < 59);

        [NativeTypeName("#define FF_API_THREAD_SAFE_CALLBACKS (LIBAVCODEC_VERSION_MAJOR < 60)")]
        public const bool FF_API_THREAD_SAFE_CALLBACKS = (58 < 60);

        [NativeTypeName("#define FF_API_DEBUG_MV (LIBAVCODEC_VERSION_MAJOR < 60)")]
        public const bool FF_API_DEBUG_MV = (58 < 60);

        [NativeTypeName("#define FF_API_GET_FRAME_CLASS (LIBAVCODEC_VERSION_MAJOR < 60)")]
        public const bool FF_API_GET_FRAME_CLASS = (58 < 60);

        [NativeTypeName("#define FF_API_AUTO_THREADS (LIBAVCODEC_VERSION_MAJOR < 60)")]
        public const bool FF_API_AUTO_THREADS = (58 < 60);

        [NativeTypeName("#define FF_API_INIT_PACKET (LIBAVCODEC_VERSION_MAJOR < 60)")]
        public const bool FF_API_INIT_PACKET = (58 < 60);
    }
}
