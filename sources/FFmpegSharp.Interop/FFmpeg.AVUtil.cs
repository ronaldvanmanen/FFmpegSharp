...
namespace FFmpegSharp.Interop
{
    public static unsafe partial class FFmpeg
    {
        ...
        public static extern int __builtin_constant_p();
        ...
        [DllImport("avutil-56.dll", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        public static extern int av_log2([NativeTypeName("unsigned int")] uint v);

        [DllImport("avutil-56.dll", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        public static extern int av_log2_16bit([NativeTypeName("unsigned int")] uint v);
        ...
        [return: NativeTypeName("int64_t")]
        public static long av_clip64_c([NativeTypeName("int64_t")] long a, [NativeTypeName("int64_t")] long amin, [NativeTypeName("int64_t")] long amax)
        {
            if (a < amin)
            {
                return amin;
        ...
        public static int av_clipl_int32_c([NativeTypeName("int64_t")] long a)
        {
            if ((((ulong)a + 0x80000000UL) & ~(0xFFFFFFFFUL)) != 0)
            {
                return (int)((a >> 63) ^ 0x7FFFFFFF);
            }
            else
            {
                return (int)(a);
        ...
        [return: NativeTypeName("unsigned int")]
        public static uint av_mod_uintp2_c([NativeTypeName("unsigned int")] uint a, [NativeTypeName("unsigned int")] uint p)
        {
            return (uint)(a & ((1U << (int)p) - 1));
        }
        ...
        [DllImport("avutil-56.dll", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        [return: NativeTypeName("bool")]
        public static extern byte __builtin_sub_overflow();
        ...
        public static int av_popcount_c([NativeTypeName("uint32_t")] uint x)
        {
            x -= (x >> 1) & 0x55555555;
        ...
        public static int av_popcount64_c([NativeTypeName("uint64_t")] ulong x)
        {
            return av_popcount_c((uint)(x)) + av_popcount_c((uint)(x >> 32));
        }

        public static int av_parity_c([NativeTypeName("uint32_t")] uint v)
        {
            return av_popcount_c(v) & 1;
        }

        [NativeTypeName("#define av_ceil_log2 av_ceil_log2_c")]
        public static readonly delegate*<int, int> av_ceil_log2 = &av_ceil_log2_c;

        [NativeTypeName("#define av_clip av_clip_c")]
        public static readonly delegate*<int, int, int, int> av_clip = &av_clip_c;

        [NativeTypeName("#define av_clip64 av_clip64_c")]
        public static readonly delegate*<long, long, long, long> av_clip64 = &av_clip64_c;

        [NativeTypeName("#define av_clip_uint8 av_clip_uint8_c")]
        public static readonly delegate*<int, byte> av_clip_uint8 = &av_clip_uint8_c;

        [NativeTypeName("#define av_clip_int8 av_clip_int8_c")]
        public static readonly delegate*<int, sbyte> av_clip_int8 = &av_clip_int8_c;

        [NativeTypeName("#define av_clip_uint16 av_clip_uint16_c")]
        public static readonly delegate*<int, ushort> av_clip_uint16 = &av_clip_uint16_c;

        [NativeTypeName("#define av_clip_int16 av_clip_int16_c")]
        public static readonly delegate*<int, short> av_clip_int16 = &av_clip_int16_c;

        [NativeTypeName("#define av_clipl_int32 av_clipl_int32_c")]
        public static readonly delegate*<long, int> av_clipl_int32 = &av_clipl_int32_c;

        [NativeTypeName("#define av_clip_intp2 av_clip_intp2_c")]
        public static readonly delegate*<int, int, int> av_clip_intp2 = &av_clip_intp2_c;

        [NativeTypeName("#define av_clip_uintp2 av_clip_uintp2_c")]
        public static readonly delegate*<int, int, uint> av_clip_uintp2 = &av_clip_uintp2_c;

        [NativeTypeName("#define av_mod_uintp2 av_mod_uintp2_c")]
        public static readonly delegate*<uint, uint, uint> av_mod_uintp2 = &av_mod_uintp2_c;

        [NativeTypeName("#define av_sat_add32 av_sat_add32_c")]
        public static readonly delegate*<int, int, int> av_sat_add32 = &av_sat_add32_c;

        [NativeTypeName("#define av_sat_dadd32 av_sat_dadd32_c")]
        public static readonly delegate*<int, int, int> av_sat_dadd32 = &av_sat_dadd32_c;

        [NativeTypeName("#define av_sat_sub32 av_sat_sub32_c")]
        public static readonly delegate*<int, int, int> av_sat_sub32 = &av_sat_sub32_c;

        [NativeTypeName("#define av_sat_dsub32 av_sat_dsub32_c")]
        public static readonly delegate*<int, int, int> av_sat_dsub32 = &av_sat_dsub32_c;

        [NativeTypeName("#define av_clipf av_clipf_c")]
        public static readonly delegate*<float, float, float, float> av_clipf = &av_clipf_c;

        [NativeTypeName("#define av_clipd av_clipd_c")]
        public static readonly delegate*<double, double, double, double> av_clipd = &av_clipd_c;

        [NativeTypeName("#define av_popcount av_popcount_c")]
        public static readonly delegate*<uint, int> av_popcount = &av_popcount_c;

        [NativeTypeName("#define av_popcount64 av_popcount64_c")]
        public static readonly delegate*<ulong, int> av_popcount64 = &av_popcount64_c;

        [NativeTypeName("#define av_parity av_parity_c")]
        public static readonly delegate*<uint, int> av_parity = &av_parity_c;
        ...
        public static int av_size_mult([NativeTypeName("size_t")] nuint a, [NativeTypeName("size_t")] nuint b, [NativeTypeName("size_t *")] nuint* r)
        {
            ...
            if ((a | b) >= ((nuint)(1) << (sizeof(nuint) * 4)) && (a) != 0 && t / a != b)
            {
                return (-(22));
            }
