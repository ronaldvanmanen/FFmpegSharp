...
namespace FFmpegSharp
{
    public static unsafe partial class FFmpeg
    {
        ...
        [DllImport("swresample-3.dll", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        public static extern int swr_build_matrix([NativeTypeName("uint64_t")] ulong in_layout, [NativeTypeName("uint64_t")] ulong out_layout, double center_mix_level, double surround_mix_level, double lfe_mix_level, double rematrix_maxval, double rematrix_volume, [NativeTypeName("double *")] double* matrix, int stride, [NativeTypeName("enum AVMatrixEncoding")] AVMatrixEncoding matrix_encoding, [NativeTypeName("void *")] void* log_ctx);
        ...
        [DllImport("swresample-3.dll", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        public static extern int swr_convert_frame([NativeTypeName("SwrContext *")] SwrContext* swr, [NativeTypeName("AVFrame *")] AVFrame* output, [NativeTypeName("const AVFrame *")] AVFrame* input);

        [DllImport("swresample-3.dll", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        public static extern int swr_config_frame([NativeTypeName("SwrContext *")] SwrContext* swr, [NativeTypeName("const AVFrame *")] AVFrame* @out, [NativeTypeName("const AVFrame *")] AVFrame* @in);
