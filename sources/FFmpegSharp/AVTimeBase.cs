...
{
    public struct AVTimeBase : IEquatable<AVTimeBase>, IComparable<AVTimeBase>
    {
        public static readonly AVTimeBase Internal = new AVTimeBase(new AVRational(1, 1000000));
