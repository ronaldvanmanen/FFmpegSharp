...
namespace FFmpegSharp
{
    public sealed unsafe class AVDictionary : IDictionary<string, string>, IDisposable
    {
        ...
        {
            var iterator = new AVDictionaryEnumerator(GetUnsafeEnumerator());
        ...
        private AVDictionaryUnsafeEnumerator GetUnsafeEnumerator()
        {
            return new AVDictionaryUnsafeEnumerator(_handle);
        }
