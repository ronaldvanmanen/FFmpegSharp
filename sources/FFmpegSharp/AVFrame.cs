...
namespace FFmpegSharp
{
    public sealed unsafe class AVFrame : IDisposable
    {
        ...
        {
            get => new AVTimeStamp(_handle->best_effort_timestamp);
        ...
        {
            get => new AVTimeStamp(_handle->pts);
        ...
        {
            get => new AVTimeStamp(_handle->pkt_pts);
        ...
        {
            get => new AVTimeStamp(_handle->pkt_dts);
        ...
        {
            get => (AVColorRange)_handle->color_range;

            set => _handle->color_range = (Interop.AVColorRange)value;
        }

        public AVColorSpace ColorSpace
        {
            get => (AVColorSpace)_handle->colorspace;

            set => _handle->colorspace = (Interop.AVColorSpace)value;
        }
