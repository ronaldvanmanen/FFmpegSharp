...
namespace FFmpegSharp
{
    ...
    {
        public static readonly AVPacket Null = new AVPacket();
        ...
        public AVTimeStamp Dts => new AVTimeStamp(_handle->dts);

        public int StreamIndex => _handle->stream_index;

        public AVPacketFlags Flags => (AVPacketFlags)_handle->flags;
        ...
        public void MoveRef(AVPacket destination)
        {
