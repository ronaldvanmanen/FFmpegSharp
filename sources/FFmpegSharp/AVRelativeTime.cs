...
{
    public struct AVRelativeTime : IEquatable<AVRelativeTime>, IComparable<AVRelativeTime>
    {
        public static readonly AVRelativeTime Undefined = new AVRelativeTime(double.NaN);

        public static readonly AVRelativeTime Zero = new AVRelativeTime(0d);
