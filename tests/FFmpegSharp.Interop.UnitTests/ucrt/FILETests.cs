...
namespace FFmpegSharp.Interop.UnitTests
{
    ...
    public static unsafe partial class FILETests
    {
        /// <summary>Validates that the <see cref="FILE" /> struct is blittable.</summary>
        [Fact]
        public static void IsBlittableTest()
        {
            Assert.Equal(sizeof(FILE), Marshal.SizeOf<FILE>());
        }
        ...
        {
            Assert.True(typeof(FILE).IsLayoutSequential);
        }
        ...
        public static void SizeOfTest()
        {
            ...
            {
                Assert.Equal(8, sizeof(FILE));
            }
            else
            {
                Assert.Equal(4, sizeof(FILE));
            }
        }
    }
}
